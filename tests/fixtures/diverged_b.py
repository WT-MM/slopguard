"""Fixture: drifted copy of diverged_a.py — retry logic added on this side only."""
    ...
    while True:
        ...
        for item in page.items:
            ...
            try:
                ...
                if client.retry_upsert(record, attempts=3):
                    synced += 1
                    logger.info("retry recovered %s", item.sku)
                    continue
